...
public class DBConnectionMgr {
    ...
    _url = "jdbc:mysql://127.0.0.1:3306/JSPWebsite?useUnicode=true&characterEncoding=UTF-8",
    _user = "root",
    _password = "1234";
    ...
    public static DBConnectionMgr getInstance() { // 1. ë�°ì�´í„°ë² ì�´ìŠ¤ ì—°ê²° í’€ ê°�ì²´ ì–»ê¸°
        if (instance == null) {
    ...
    public synchronized Connection getConnection() 
            throws Exception { // 2. ì–»ì–´ì§„ í’€ë¡œ Connection ê°�ì²´ ì–»ê¸° 
        if (!initialized) {
